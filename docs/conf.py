# -*- coding: utf-8 -*-
#
# tox-envreport documentation build configuration file, created by
...
htmlhelp_basename = 'tox-cookiecutterplugin_namedoc'
...
latex_documents = [
  (master_doc, 'tox-cookiecutterplugin_name.tex', u'tox-\\{\\{cookiecutter.plugin\\_name\\}\\} Documentation',
...
man_pages = [
    (master_doc, 'tox-cookiecutterplugin_name', u'tox-envreport Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'tox-cookiecutterplugin_name', u'tox-envreport Documentation',
   author, 'tox-cookiecutterplugin_name', 'One line description of project.',
   'Miscellaneous'),
]
